        ...
        <div className="flex items-center flex-shrink-0">
          ...
          >
            ...
            <div className="hidden sm:flex flex-col">
              ...
              <span className="text-sm text-slate-500 leading-tight dark:text-slate-400">
                System
              </span>
            </div>
          </Link>
        ...
        <div className="flex items-center gap-2">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button
                variant="ghost"
                className="relative h-10 w-10 rounded-full hover:bg-slate-100 transition-all duration-200 shadow-sm border border-slate-200/50 dark:border-slate-700/60 dark:hover:bg-slate-700/60"
              >
            ...
            <DropdownMenuContent className="w-56" align="end" forceMount>
              ...
              <DropdownMenuItem asChild>
                <Link
                  ...
                  className="flex items-center cursor-pointer gap-2 px-2 py-2 rounded-md hover:bg-slate-100 transition-colors"
                >
